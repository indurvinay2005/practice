...
def equals():
    ...
    # except UnboundLocalError:
        ...
        # equation_label.set("Local error")
        # equation_text = "" 
...
# percentage = Button(frame, text= '%', height=4, width= 9, font=35, command=lambda:button_press('%'))
...
clearall = Button(window, text= 'clear', height=4, width= 12, font=35, command=clear)
clearall.pack()
